            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="card-title">FORM EDIT DATA PASIEN</h1>
                                <div class="form-validation">
                                    <form class="form-valide" action="{{'/pasien/'.$p->no_rm}}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="no_rm" name="no_rm" placeholder="Masukkan Nomor Rekam Medis Pasien.." disabled value="{{$p->no_rm}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-name" name="nama_pasien" placeholder="Nama pasien.." value="{{$p->nama_pasien}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control" id="val-alamat" name="alamat" rows="5" placeholder="Masukkan alamat.." value="{{$p->alamat}}"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-jk" name="jk" value="{{$p->jk}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="Nomor hp.." value="{{$p->no_hp}}">
                                            </div>
                                        </div>
                                        {{-- <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="mdate" name="tgl_lahir" placeholder="yy-mm-dd" value="{{$p->tgl_lahir}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
